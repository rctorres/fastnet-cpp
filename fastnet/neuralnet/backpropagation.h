  ...
  */
  class Backpropagation : public NeuralNetwork 
  {
    ...
    public:
      ...
      */
      virtual void calculateNewWeights(const REAL *output, const REAL *target, const unsigned patIdx) = 0;
      ...
      */
      virtual void addToGradient(const NeuralNetwork *net)=0;
      ...
      */
      ...
      @param[in] net The network from where to get the gradients from.
      */
      virtual void addToGradient(const NeuralNetwork *net);
