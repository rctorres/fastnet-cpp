%function [outNet, epoch, trnError, valError] = ntrain(net, in_trn, out_trn, in_val, out_val, trnESize)
...
%
%function [outNet, epoch, trnError, valError] = ntrain(net, in_trn, [], in_val, [], trnESize)
